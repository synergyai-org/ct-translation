    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        for iteration, (x_val , y_val) in enumerate(data_loader_val): 
            ...
            if iteration % 100 == 0:
                ...
                ax[0].set_title('synthetic pre-contrast')
                ax[0].imshow(fake_sample1[0,0,:,:], cmap = 'gray') # get first image of batch
                ax[1].set_title('true pre-contrast')
                ax[1].imshow(real_data[0,0,:,:], cmap = 'gray')
                fig.savefig(f'/home/synergyai/jth/ct-translation-research/figures/{epoch:03}_{iteration:04}_toPre.png')
        ...
        for iteration, (y_val , x_val) in enumerate(data_loader_val): 
            ...
            if iteration % 100 == 0:
                fig, ax = plt.subplots(1,2, figsize=(10,5))
                ax[0].set_title('synthetic post-contrast')
                ax[0].imshow(fake_sample1[0,0,:,:], cmap = 'gray') # get first image of batch
                ax[1].set_title('true post-contrast')
                ax[1].imshow(real_data[0,0,:,:], cmap = 'gray')
                fig.savefig(f'/home/synergyai/jth/ct-translation-research/figures/{epoch:03}_{iteration:04}_toPost.png')
